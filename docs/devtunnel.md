...
Complete [installation](installation.md) on each computer first. The commands below connect an installed coding client to an existing memory server. Local use needs no sharing step.
