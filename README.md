...
The v0.1.3 preview supports Windows x64 with Windows PowerShell 5.1 or PowerShell 7. Install Git and have a Copilot account available for sign-in. Use the commands from the published version you select; `-ClientOnly` requires v0.1.2 or later.
