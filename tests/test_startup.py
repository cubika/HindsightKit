...
from hindsightkit import cli, connection, lifecycle, remote, services, startup
...
class StartupTests(unittest.TestCase):
    def setUp(self):
        ...
        self.private = self.stack.enter_context(patch('hindsightkit.postgres.private_directory',
